...
async def run_evaluation(client, in_path, o_dir, eval_model="qwen3-32b", temperature=0.01):
    ...
    results = []
    pbar = tqdm_asyncio(total=len(tasks), desc="Processing entries")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--temperature", type=float, default=0.01, help="temperature to be used for evaluation")
